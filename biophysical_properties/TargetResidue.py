...
class TargetResidue(object):
    ...
    def get_features(self, clean_pdb_file, wild_fasta_file, mutant_fasta_file, wild_residue, 
                     mutant_residue, chain_id, mutation_site, zero_based_mutation_site):
        ...
        wild_residue_pssm_score = self.pssm.of_a_residue(residue_index=zero_based_mutation_site)
        self.pssm.set_up(mutant_fasta_file)
        mutant_residue_pssm_score = self.pssm.of_a_residue(residue_index=zero_based_mutation_site)
